...
class Robot:
    ...
    def __init__(
        ...
        height=0.0,
        color=(0.8, 0.0, 0.8),
        carried_object = None,  # Inizialmente il robot non trasporta alcun oggetto-AGGIUNTA IO
    ...
    def log_action(self, action):
        """Logga l'azione eseguita dal robot."""
        logging.info(f"{self.name} executed action: {action}")
    def get_pose(self):
        """
        Gets the robot pose.
